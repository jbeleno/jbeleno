...
- 🔧 **Backend development** with **Python** (FastAPI & Flask) and **Java**  
- 🗄️ **Relational databases**: PostgreSQL, MySQL, SQL Server  
- 📊 **Data Science**: enthusiastic and always learning  
- 🤖 **Computer Vision**: developing **CNN models** for recognition and analysis  
